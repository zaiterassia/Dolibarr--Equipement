...
/**
 * \file    equipement/core/boxes/equipementwidget1.php
 * \ingroup equipement
 * \brief   Widget provided by Equipement
 *
 ...
 */
class equipementwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "equipementbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "equipement@equipement";
	 ...
	 */
	public $depends = array('equipement');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->equipement->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("EquipementBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_equipement@equipement',
