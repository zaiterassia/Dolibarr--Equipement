...
/**
 * \file    test/phpunit/EquipementFunctionalTest.php
 * \ingroup equipement
...
/**
 * Class EquipementFunctionalTest
 *
 ...
 *
 * @package Testequipement
 */
class EquipementFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEquipement')->click();
		} else {
			// Disable the module
			$this->byHref('modEquipement')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/equipement/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('equipement/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/equipement/admin/about.php');
		$this->authenticate();
		return $this->assertContains('equipement/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('equipementwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEquipement_EquipementTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEquipement_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
