...
/**
 *	\file       equipement/equipementindex.php
 *	\ingroup    equipement
 *	\brief      Home page of equipement top menu
 */
...
$langs->loadLangs(array("equipement@equipement"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->equipement->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("EquipementArea"));

print load_fiche_titre($langs->trans("EquipementArea"), '', 'equipement.png@equipement');
...
// Draft MyObject
if (! empty($conf->equipement->enabled) && $user->rights->equipement->read)
{
	$langs->load("orders");
